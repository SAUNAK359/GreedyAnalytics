...
from analytics_llm.frontend.agents.planner import PlannerAgent
from analytics_llm.frontend.agents.executor import ExecutorAgent
from analytics_llm.frontend.agents.verifier import VerifierAgent
from analytics_llm.frontend.dashboard.mcp_mutator import mutate_dashboard
from analytics_llm.frontend.storage.state_store import append_chat
...
def render_copilot_panel() -> None:
    ...
    with st.sidebar:
        ...
        if prompt:
            ...
            versions = st.session_state.setdefault("mcp_versions", [])
